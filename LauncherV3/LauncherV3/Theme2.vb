...
Class OrainsTheme
    ...
    Sub New()
        ...
        SetColor("ForeColor", Color.FromArgb(0, 121, 203))
    ...
    Protected Overrides Sub ColorHook()
        TextColor = Color.FromArgb(0, 121, 203)
    ...
    Protected Overrides Sub PaintHook()
        ...
        G.DrawString(FindForm.Text, Font, New SolidBrush(TextColor), New Point(10, 7))
...
Class OrainsButton
    ...
    Sub New()
        ...
        SetColor("Text", Color.FromArgb(0, 121, 203))
...
Class OrainsRadioButton
    ...
    Protected Overrides Sub PaintHook()
        ...
        If State = MouseState.Over Then
            G.FillEllipse(New SolidBrush(Color.FromArgb(20, Color.FromArgb(0, 121, 203))), 5, 5, 6, 6)
        End If
...
Class OrainsCheckBox
    ...
    Protected Overrides Sub PaintHook()
        ...
        If _Checked Then
            G.FillRectangle(New SolidBrush(Color.FromArgb(0, 121, 203)), New Rectangle(3, 3, 10, 10))
        ...
        If State = MouseState.Over Then
            G.FillRectangle(New SolidBrush(Color.FromArgb(20, Color.FromArgb(0, 121, 203))), 3, 3, 10, 10)
        End If
...
Class OrainsTextBox
    ...
    Sub New()
        DoubleBuffered = True
        BackColor = Color.FromArgb(20, 20, 20)
        ForeColor = Color.FromArgb(0, 121, 203)
        Text = Text
...
Class OrainsComboBox ' Credits Mavamaarten For the ComboBox Code =))
    ...
    Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
        ...
        If SelectedIndex <> -1 Then
            G.DrawString(Items(SelectedIndex), Font, New SolidBrush(Color.FromArgb(0, 121, 203)), 4, Height \ 2 - S1 \ 2)
        Else
            If Not Items Is Nothing And Items.Count > 0 Then
                G.DrawString(Items(0), Font, New SolidBrush(Color.FromArgb(0, 121, 203)), 4, Height \ 2 - S1 \ 2)
            Else
                G.DrawString("OrainsComboBox", Font, New SolidBrush(Color.FromArgb(0, 121, 203)), 4, Height \ 2 - S1 \ 2)
            End If
        End If
    ...
    Protected Overrides Sub OnDrawItem(ByVal e As DrawItemEventArgs)
        ...
        Else
            e.Graphics.FillRectangle(New SolidBrush(BackColor), e.Bounds)
            e.Graphics.DrawString(" " & Items(e.Index).ToString(), Font, Brushes.DarkSlateBlue, e.Bounds.X, e.Bounds.Y + 1)
    ...
    Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
        ...
        Select Case ButtonState
            ...
            Case ButtonHover.Minimize
                ...
                G.DrawString("0", ButtonFont, New SolidBrush(Color.FromArgb(0, 121, 203)), New Point(22, 7), New StringFormat With {.Alignment = StringAlignment.Center})
